...
<body>
    ...
    <div class="container">
        ...
        <!-- Create quiz form -->
        <form action="${pageContext.request.contextPath}/admin/quiz/create" method="post" id="quizForm">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="isPublished" id="active" value="true" checked>
                    <label class="form-check-label" for="active">Active</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="isPublished" id="inactive" value="false">
