    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-logo">
                <img src="${pageContext.request.contextPath}/pics/logo.svg" alt="Quiz App">
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/footer.css">
                <style>
                /* Professional Footer Styling for Quiz App */
...
/* Button Styling (Consistent with header and dashboard) */
.btn {
