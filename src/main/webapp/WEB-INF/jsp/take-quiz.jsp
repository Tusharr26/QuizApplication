...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/take-quiz.css">
    <style>
    /* --------------------------------------------
...
<body>
    ...
    <div class="container">
        <div class="quiz-container">
            ...
            <c:set var="progressPercentage" value="${(currentQuestionIndex * 100) / fn:length(questions)}" />

            <div class="quiz-progress">
                <div class="progress-bar">
                    <div class="progress" style="width: ${progressPercentage}%"></div>
                </div>
                <p>Question ${currentQuestionIndex + 1} of ${fn:length(questions)}</p>
            </div>
